...
// defaultHNSClient returns nil on Linux; the field is never read because
// ReleaseIPs does not call deleteEndpoint here.
func defaultHNSClient() hnsEndpointClient { return nil }
