...
func TestReconcile(t *testing.T) {
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			r := NewReconciler(&tt.cnsClient, func(*v1alpha.NodeNetworkConfig) error { return nil }, &tt.cnsClient, tt.nodeIP)
...
func TestReconcileStaleNCs(t *testing.T) {
	...
	r := NewReconciler(&cnsClient, func(*v1alpha.NodeNetworkConfig) error { return nil }, &cnsClient, nodeIP)
...
func TestReconcileInitializerRunsOnceOnSuccess(t *testing.T) {
	...
	r := NewReconciler(&cnsClient, initializer, &cnsClient, "")
	r.nnccli = &ncGetter
