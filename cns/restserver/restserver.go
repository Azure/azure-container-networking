...
type HTTPRestService struct {
	*cns.Service
	...
	nmagentClient            nmagent.Interface
...
func NewHTTPRestService(config *common.ServiceConfig, wscli interfaceGetter, nmagentClient nmagent.Interface) (cns.HTTPService, error) {
