...
// +kubebuilder:validation:Enum=Ready;InUse;SubnetNotDelegated;SubnetDelegationValidateFailed
type Status string
...
const (
	...
	SubnetDelegationValidateFailed Status = "SubnetDelegationValidateFailed"
)
