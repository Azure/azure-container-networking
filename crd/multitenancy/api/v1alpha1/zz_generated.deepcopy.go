...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodNetworkInstanceItem) DeepCopyInto(out *PodNetworkInstanceItem) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodNetworkInstanceItem.
func (in *PodNetworkInstanceItem) DeepCopy() *PodNetworkInstanceItem {
	if in == nil {
		return nil
	}
	out := new(PodNetworkInstanceItem)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PodNetworkInstanceSpec) DeepCopyInto(out *PodNetworkInstanceSpec) {
	*out = *in
	if in.PodNetworks != nil {
		in, out := &in.PodNetworks, &out.PodNetworks
		*out = make([]PodNetworkInstanceItem, len(*in))
		copy(*out, *in)
	}
}
