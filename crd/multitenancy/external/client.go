...
import (
	...
	"github.com/Azure/azure-container-networking/crd/multitenancy/external/api/v1alpha1"
...
// Scheme is a runtime scheme containing the client-go scheme and the PodNetwork/PodNetworkInstance scheme.
...
// Installer provides methods to manage the lifecycle of the PodNetwork/PodNetworkInstance resource definition.
