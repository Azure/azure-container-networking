...
var (
	...
	// ErrTooManySelectorMatches covers excessive pod or namespace selector matches,
	// including generated namespace anchors and named-port conditions.
	ErrTooManySelectorMatches = errors.New("selector or rule expands into too many set matches")
