...
func (f *nameSpaceFixture) newNsController(stopCh chan struct{}) {
	...
	f.nsController = NewNamespaceController(
		f.kubeInformer.Core().V1().Namespaces(), dp, npmNamespaceCache)
...
func TestV2AddNamespace(t *testing.T) {
	fexec := exec.New()
...
func TestV2UpdateNamespace(t *testing.T) {
	fexec := exec.New()
	f := newNsFixture(t, fexec)
...
func TestV2AddNamespaceLabel(t *testing.T) {
	fexec := exec.New()
	f := newNsFixture(t, fexec)
...
func TestV2AddNamespaceLabelSameRv(t *testing.T) {
	fexec := exec.New()
	f := newNsFixture(t, fexec)
...
func TestV2DeleteandUpdateNamespaceLabel(t *testing.T) {
	fexec := exec.New()
	f := newNsFixture(t, fexec)
...
func TestV2NewNamespaceUpdate(t *testing.T) {
	fexec := exec.New()
	f := newNsFixture(t, fexec)
...
func TestV2DeleteNamespace(t *testing.T) {
	fexec := exec.New()
	f := newNsFixture(t, fexec)
...
func TestV2DeleteNamespaceWithTombstone(t *testing.T) {
	fexec := exec.New()
	f := newNsFixture(t, fexec)
	stopCh := make(chan struct{})
	defer close(stopCh)
...
func TestV2DeleteNamespaceWithTombstoneAfterAddingNamespace(t *testing.T) {
	nsObj := newNamespace(
		"test-namespace",
		"0",
		map[string]string{
...
func TestV2GetNamespaceObjFromNsObj(t *testing.T) {
	ns := newNs("test-ns")
...
func TestV2IsSystemNs(t *testing.T) {
...
func TestV2NSMapMarshalJSON(t *testing.T) {
