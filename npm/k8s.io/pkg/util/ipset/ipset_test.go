...
var testCases = []struct {
	...
	{ // case 8
		...
		addCombinedOutputLog: [][]string{
			{"ipset", "add", "HUIT", "192.168.0.0/24"},
			{"ipset", "add", "HUIT", "192.168.0.0/24", "-exist"},
		},
		delCombinedOutputLog: []string{"ipset", "del", "HUIT", "192.168.0.0/24"},
	},
	{ // case 9
		entry: &Entry{
			NestedSet: "nestedset",
		...
		addCombinedOutputLog: [][]string{
			{"ipset", "add", "NEUVE", "nestedset"},
			{"ipset", "add", "NEUVE", "nestedset", "-exist"},
		},
		delCombinedOutputLog: []string{"ipset", "del", "NEUVE", "nestedset"},
	},
}
