...
type Entry struct {
	...
	SetType Type
	// NestedSet is the name of an set to be added to another set for an ordered union of sets.
	// Used for 'list:set' type ipset.
	NestedSet string
}
...
func (e *Entry) String() string {
	...
	case NetHash:
		// Entry{10.0.1.0/24} -> 192.168.1.2,udp:80,10.0.1.0/24
		return e.Net
	case SetList:
