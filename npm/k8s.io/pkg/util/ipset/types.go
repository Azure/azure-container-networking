...
const (
	...
	// NetHash represents a hash to store CIDR netblocks, which may be of different sizes.
	// The same techique is used to avoid clashes as at the hash:ip set type.
	NetHash Type = "hash:net"
	//SetList of set you can store other sets; it is like an ordered union of different sets.
	SetList Type = "list:set"
)
