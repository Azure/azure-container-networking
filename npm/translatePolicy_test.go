	...
	expectedIptEntries := []*iptm.IptEntry{
		...
		&iptm.IptEntry{
			...
			Specs: []string{
				...
				util.IptablesCommentModuleFlag,
				util.IptablesCommentFlag,
				"ALLOW-ALL-TO-context:dev-AND-!testNotIn:frontend-TO-JUMP-TO-" +
					util.IptablesAzureIngressFromChain,
			},
		},
		&iptm.IptEntry{
	...
	expectedIptEntries := []*iptm.IptEntry{
		...
		&iptm.IptEntry{
			...
			Specs: []string{
				...
				util.IptablesCommentModuleFlag,
				util.IptablesCommentFlag,
				"ALLOW-ALL-FROM-context:dev-AND-!testNotIn:frontend-TO-JUMP-TO-"+util.IptablesAzureEgressToChain,
			},
		},
		&iptm.IptEntry{
	...
	nonKubeSystemEntries = []*iptm.IptEntry{
		...
		&iptm.IptEntry{
			...
			Specs: []string{
				...
				util.IptablesCommentModuleFlag,
				util.IptablesCommentFlag,
				"ALLOW-ALL-TO-app:frontend-TO-JUMP-TO-"+util.IptablesAzureIngressFromChain,
			},
		},
		&iptm.IptEntry{
			Chain: util.IptablesAzureIngressFromChain,
	...
	nonKubeSystemEntries = []*iptm.IptEntry{
		...
		&iptm.IptEntry{
			...
			Specs: []string{
				...
				util.IptablesCommentModuleFlag,
				util.IptablesCommentFlag,
				"ALLOW-ALL-FROM-role:db-TO-JUMP-TO-AZURE-NPM-EGRESS-TO",
			},
		},
		&iptm.IptEntry{
			Chain: util.IptablesAzureEgressToChain,
			Specs: []string{
				...
				util.IptablesCommentModuleFlag,
				util.IptablesCommentFlag,
				"ALLOW-ALL-FROM-role:db-TO-JUMP-TO-AZURE-NPM-TARGET-SETS",
			},
		},
		&iptm.IptEntry{
			Chain: util.IptablesAzureTargetSetsChain,
