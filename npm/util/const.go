...
const (
	...
	NPMIngressNsGroup     string = "NPM_INGRESS_NS"
	NPMIngressNsPriority  string = "101"
	NPMIngressPodGroup    string = "NPM_INGRESS_POD"
	NPMIngressPodPriority string = "102"
	NPMEgressGroup        string = "NPM_EGRESS"
	NPMEgressPriority     string = "103"
	NPMEgressNsGroup      string = "NPM_EGRESS_NS"
	NPMEgressNsPriority   string = "104"
	NPMEgressPodGroup     string = "NPM_EGRESS_POD"
	NPMEgressPodPriority  string = "105"
	NPMDefaultInGroup     string = "NPM_DEFAULT_IN"
	NPMDefaultInPriority  string = "106"
	NPMDefaultOutGroup    string = "NPM_DEFAULT_OUT"
	NPMDefaultOutPriority string = "107"
