...
const (
	...
	NPMIngressPortGroup    string = "NPM_INGRESS_PORT"
	NPMIngressPortPriority string = "101"
	NPMIngressFromGroup    string = "NPM_INGRESS_FROM"
	NPMIngressFromPriority string = "102"
	NPMEgressGroup         string = "NPM_EGRESS"
	NPMEgressPriority      string = "103"
	NPMEgressPortGroup     string = "NPM_EGRESS_PORT"
	NPMEgressPortPriority  string = "104"
	NPMEgressToGroup       string = "NPM_EGRESS_TO"
	NPMEgressToPriority    string = "105"
