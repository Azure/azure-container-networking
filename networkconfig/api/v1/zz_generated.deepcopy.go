...
func (in *AvailableIPMapping) DeepCopyInto(out *AvailableIPMapping) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AvailableIPMapping.
func (in *AvailableIPMapping) DeepCopy() *AvailableIPMapping {
	if in == nil {
		return nil
	}
	out := new(AvailableIPMapping)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NetworkConfigStatus) DeepCopyInto(out *NetworkConfigStatus) {
	*out = *in
	if in.NCs != nil {
		in, out := &in.NCs, &out.NCs
		*out = make([]NetworkContainerSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NetworkContainerSpec) DeepCopyInto(out *NetworkContainerSpec) {
	*out = *in
	if in.AvailableIPs != nil {
		...
		*out = make([]AvailableIPMapping, len(*in))
		copy(*out, *in)
	}
}
