...
func (plugin *netPlugin) handleConsecutiveAdd(args *cniSkel.CmdArgs, endpointID string, nwInfo network.NetworkInfo,
	epInfo *network.EndpointInfo, nwCfg *cni.NetworkConfig) (*cniTypesCurr.Result, error) {
	return nil, nil
}
