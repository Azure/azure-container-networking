...
func TestGetMultiTenancyCNINCResponses(t *testing.T) {
	require := require.New(t) //nolint:gocritic
	var ncs []cns.GetNetworkContainerResponse

	nc1 := &cns.GetNetworkContainerResponse{
