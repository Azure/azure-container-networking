...
// Check:(JUNGUK) OSInfo is used in GetReport() -> GetOSDetails() in telemetry_linux.go
...
// Check:(JUNGUK) SystemInfo is used in GetReport() -> GetSystemDetails() in telemetry_linux.go
...
// Check:(JUNGUK) InterfaceInfo is used in setCNIReportDetails() in cni/network/network.go
...
// Check:(JUNGUK) BridgeInfo is used in setCNIReportDetails() in cni/network/network.go
...
// Check:(JUNGUK) CNIReport is used in  cnms/service/networkmonitor.go and cni/network/network.go
